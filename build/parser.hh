...
/**
 ** \file /home/compiler/build/parser.hh
...
#ifndef YY_YY_HOME_COMPILER_BUILD_PARSER_HH_INCLUDED
# define YY_YY_HOME_COMPILER_BUILD_PARSER_HH_INCLUDED
...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    TOK_LC = 23,                   // LC
    TOK_RC = 24,                   // RC
    TOK_STRUCT = 25,               // STRUCT
    TOK_RETURN = 26,               // RETURN
    TOK_IF = 27,                   // IF
    TOK_ELSE = 28,                 // ELSE
    TOK_WHILE = 29,                // WHILE
    TOK_LOWER_THAN_ELSE = 30       // LOWER_THAN_ELSE
      };
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_ELSE = 28,                             // ELSE
        S_WHILE = 29,                            // WHILE
        S_LOWER_THAN_ELSE = 30,                  // LOWER_THAN_ELSE
        S_YYACCEPT = 31,                         // $accept
        S_Program = 32,                          // Program
        S_ExtDefList = 33,                       // ExtDefList
        S_ExtDef = 34,                           // ExtDef
        S_ExtDecList = 35,                       // ExtDecList
        S_Specifier = 36,                        // Specifier
        S_StructSpecifier = 37,                  // StructSpecifier
        S_OptTag = 38,                           // OptTag
        S_Tag = 39,                              // Tag
        S_VarDec = 40,                           // VarDec
        S_FunDec = 41,                           // FunDec
        S_VarList = 42,                          // VarList
        S_ParamDec = 43,                         // ParamDec
        S_CompSt = 44,                           // CompSt
        S_StmtList = 45,                         // StmtList
        S_Stmt = 46,                             // Stmt
        S_DefList = 47,                          // DefList
        S_Def = 48,                              // Def
        S_DecList = 49,                          // DecList
        S_Dec = 50,                              // Dec
        S_Exp = 51,                              // Exp
        S_Args = 52                              // Args
      };
...
switch (yykind)
    ...
    struct symbol_type : basic_symbol<by_kind>
    {
...
#endif
      {
        ...
        YY_ASSERT (tok == token::TOK_YYEOF
                   ...
                   || (token::TOK_SEMI <= tok && tok <= token::TOK_LOWER_THAN_ELSE));
#endif
      }
#if 201103L <= YY_CPLUSPLUS
    ...
    // Implementation of make_symbol for each token kind.
      ...
      static
      symbol_type
      make_ASSIGNOP (location_type l)
      {
        return symbol_type (token::TOK_ASSIGNOP, std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::TOK_LC, std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::TOK_LC, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
...
#endif // !YY_YY_HOME_COMPILER_BUILD_PARSER_HH_INCLUDED
